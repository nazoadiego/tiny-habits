...
export class Cursor implements TCursor {
	...
	/**
	 ...
	 @param init.verticalPosition Index based number with the current cursor position vertically. Is always between 0 and verticalTotal - 1
	 @param init.horizontalPosition Index based number with the current cursor position vertically. Is always between 0 and horizontalTotal - 1
	 @param init.verticalTotal The total number of positions vertically, it maps to the number of total habits in the table. Always a positive integer.
	 @param init.horizontalTotal The total number of positions horizontally, it maps to the number of total entry days in the table. Always a positive integer.
	 */
	...
	/**
	 ...
	 - etc.
	 @summary If there is a position available in that direction, the cursor changes position there
	 @example
	 cursor.verticalTotal // 3
	 cursor.verticalPosition // 1
	 cursor.up()
	 cursor.verticalPosition // 0
	 @summary If there are no more positions available, it cycles back to the last or first one, depending on the direction.
	 @example
	 cursor.verticalTotal // 3
	 cursor.verticalPosition // 0
	 cursor.up()
	...
	*/
	...
	/**
	 @description
	 Moves the cursor up to the previous habit
